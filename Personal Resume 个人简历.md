(-- `林昕 - 简历 - Google Docs` [google](https://docs.google.com/document/d/17O4Uwso5h7sloxNVx987fsLwGZ6R2tDiYv8kp4osE_E/edit#))
...
在我的职业生涯早期, 我曾在上海维塔士电脑软件有限公司担任次世代游戏角色设计师。随后在香港 Viva 担任工业设计师期间，参与了迪士尼及《终结者2》等影视周边包装产品的数字原型与结构设计，并在将数字网格模型应用于注塑量产与 CNC 加工的逆向工程中积累了经验。此外, 我还曾在 Zhong Art International.srl 担任佛罗伦萨博物馆项目策划及数据采集. 
...
2024.09 - 至今, 广州南方学院 | 专任教师，负责日常教学工作
2021.09 - 至今, 广州美术学院雕塑与公共艺术学院 | 外聘讲师，负责数字雕塑理论与创作课程讲授
2017.01 - 2021.12, Zhong Art International.srl | 项目策划，负责佛罗伦萨博物馆相关数字项目策划及数据采集
2009.01 - 2010.08, Viva（香港） | 美术 / 工业设计师，负责影视IP 3D造型设计与从高精度网格原型(STL/OBJ)至注塑加工实体模型的逆向转换
2007.07 - 2009.12, 上海维塔士电脑软件有限公司 | 游戏角色艺术家，参与次世代游戏项目角色设计
...
- 2009 年 作为三维设计师参与迪士尼及《终结者2》等影视 IP 的周边产品与包装造型开发, 负责数字原型的工业曲面重建与逆向工程转换工作.
...
### 2007 数字生命形式探索
我曾专注用数字媒体(digital media)为静物实体赋予生命感。
当代动能雕塑(Kinetic)让我开始着迷于数字对象的形式, 我认识到数字对象应该具有数字生命的感受和反应机制，唤醒沉睡在数据中的情感与智慧触动人类的情感并促进人机交互。我开始关注如何在虚拟环境中实现高度逼真的视觉效果。更深入研究如何塑造具有可信度和感官吸引力的数字形态，探索如何在虚拟的世界里捕捉真实，赋予数字形态以生活的气息，使观者能够感知到它们的存在。以提高观察者的沉浸感。

#### 2007 雕塑合唱团
在2007年（16年前），我完成了我第一个动画 <雕塑合唱团>《智斗》, 获镇泰奖，并被广州美术学院美术馆收藏 

#### 2014 La Gioconda di Firenze
2014年，12月 达芬奇博物馆(达芬奇故居遗址)为我提供了个人的实验空间, 创作<佛罗伦萨的蒙娜丽莎>。参观者可以在我创作<佛罗伦萨的蒙娜丽莎>的过程并与我交谈，这个作品包括一个头部追踪装置及显示屏，当观众以不同视觉观察时蒙娜丽莎身上会呈现不同的[[Fibonacci]]数列结果，能为他们还原 800年前达芬奇观察蒙娜丽莎的场景, 以揭示达芬奇眼中的最佳视角。(这个作品引发了我对人工智能教学助手及其非线性教育潜力的好奇心)。


### 2009 将数字雕刻引入工业量产的探索
2009年，在参与狮门影业《终结者2》限量版头骨套装及迪士尼周边产品的包装结构设计时，我开始尝试解决复杂有机造型从概念设计到工业量产的技术转化问题。
当时《终结者2》的头骨模型以高精度网格原型（STL/OBJ）的形式授权提供，无法直接用于工厂加工。为此，我运用逆向工程建模方法进行了曲面重建 [^highdetailedpolygonalModel]，将其转换为符合批量注塑加工标准的实体模型。这项转换工作不仅保留了模型原有的美感，也成功满足了批量注塑工艺对数字资产的精度要求。这次实践让我认识到数字技术在突破传统制造技术限制方面的潜力。 


### 2010 意大利
在2010年，随后我在佛罗伦萨获得硕士学位,在教授引导下, 我开始专注于用人文科学解决数字环境的问题. 
When I was in Italy, my professor always guided me to focus on the humanities.

### 2014  "Pattern/Partner"
#### abstract

在 **数字创作中**, 鼠标限制了**数字艺术家**运动空间, 因为它只允许艺术家在二维的空间上操作对象, 
I have also found that the limitations of existing digital technologies may `undermine` the creativity of artists.
Take 3D modeling software as an example, the mouse (graphics tablet) restricts the artist's creative movement space, because it only allows the artist to operate objects in a two-dimensional space, which restricts the artist's freedom to express emotions.

我们知道像, 抽象表现主义的艺术家完全靠**运动的自由**抒发情感的
所以鼠标确实, 限制了艺术家情感的表达. 以及突发事件所产生的作品随机性.
Take 3D modeling software as an example, the mouse (graphics tablet) restricts the artist's creative movement space, because it only allows the artist to operate objects in a two-dimensional space, which restricts the artist's freedom to express emotions. 
...
因此 14 年我开发了可用于三维运动的创作应用程序 <Pattern/Partner> , 它包括两个核心部分:艺术家风格数据库 Pattern 和 6自由度(6 Degrees of Freedom, 6DoF)图形雕塑控制器 Partner。
#### Body
 <Pattern/Partner>  的命名来源于我想象中文艺复兴大师与当代艺术家跨越时空的对话。通过这个装置,创作者能用当代抽象主义的创作方式,创造出文艺复兴时期大师风格的数字雕塑。
该装置包括两个核心部分:一个艺术家风格的数据库(Pattern)和一个6自由度(6 Degrees of Freedom, 6DoF[^6DoF])的图形雕塑控制器(Partner)。
...
作为学生或艺术家, 我们不仅需要掌握先进的技术和方法，我们将成为数字世界的创造者，尊重每一个创作对象的心。请把每一个数字生命视为有灵魂的存在，并关注这个数字生态的平衡，强调创新而非简单地复制现有的物品。我们将以人为中心的视角来审视现实与虚拟世界的关系，以及技术、艺术和人性之间的互动。关注数字雕塑对社会、文化和伦理的影响, 推动其朝着更加人性化和可持续的方向发展。
