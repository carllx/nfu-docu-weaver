参考  [Monitor the Heart Rate using Pulse Sensor and Arduino](https://lastminuteengineers.com/pulse-sensor-arduino-tutorial/)

![|400](https://lastminuteengineers.b-cdn.net/wp-content/uploads/featuredimages/Arduino-Tutorial-for-Interfacing-Pulse-Sensor.webp)

Arduino IDE > Library Manager > 搜索install "pulsesensor"

[Google A.I GoEmotion 用于细粒度情感分类的数据集](https://ai.googleblog.com/2021/10/goemotions-dataset-for-fine-grained.html) [[A.I Training ChatGPT 2.0]]
