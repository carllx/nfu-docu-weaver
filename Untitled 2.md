...
Anyone on any plan can create styles. Anyone on [Education, Professional, Organization, and Enterprise plans](https://help.figma.com/hc/en-us/articles/360040328273) can publish styles.
...
课程需要主要衔接 Like [components](https://help.figma.com/hc/en-us/articles/360038662654-Guide-to-Components-in-Figma) or [variables](https://help.figma.com/hc/en-us/articles/15339657135383), 
**Tip**: Like [components](https://help.figma.com/hc/en-us/articles/360038662654-Guide-to-Components-in-Figma) or [variables](https://help.figma.com/hc/en-us/articles/15339657135383), styles can be shared by publishing them to your [team library](https://help.figma.com/hc/en-us/articles/360025508373-Publish-styles-and-components-to-a-library). This allows you to easily establish and maintain consistent styles across your team projects.
...
Creating styles is available on [all plans](https://help.figma.com/hc/en-us/articles/360040328273) can create styles. Publishing styles is available on Education, Professional, Organization, and Enterprise plans.
...
- **Layout guides for frames**: row, column, uniform grid
    ...
    - Guide styles are represented as icons in the **********************Layout guides********************** section of the right sidebar and vary according to type: **Uniform g******************************************rid, Columns,******************************************** or ********************************************Rows********************************************. Learn more about [layout guides](https://help.figma.com/hc/en-us/articles/360040450513-Create-layout-grids-with-grids-columns-and-rows).
...
![bg fit left:50% vertical](https://i.imgur.com/EXcUany.webp)
...
Tip! If you aren't able to access styles from the properties panel, they may not be shared to your team library yet. Learn more about [managing and sharing styles](https://help.figma.com/hc/en-us/articles/360039820134-Manage-and-share-styles).
...
![](https://cdn.sanity.io/images/599r6htc/regionalized/f97467c6330dc7c4c68e95bc74ad67545bbaf5cc-1472x708.png?w=1472&h=708&q=75&fit=max&auto=format)
...
![A process within Figma where styles are created and enabled throughout](https://cdn.sanity.io/images/599r6htc/regionalized/28443957d991aa876520c1e8be4a98c7734d4365-3392x1302.png?w=3392&h=1302&q=75&fit=max&auto=format)
...
![different types of components in Figma](https://cdn.sanity.io/images/599r6htc/regionalized/023869c684ef81e8a34cfdbd623ad2bfa1c54193-2156x1186.png?w=2156&h=1186&q=75&fit=max&auto=format)
...
![diagram of how nested components are connected](https://cdn.sanity.io/images/599r6htc/regionalized/37f58f87d2387114704b1e3d57c79d321001ca13-2156x1302.png?w=2156&h=1302&q=75&fit=max&auto=format)

Groups or frames nested within a component can be toggled with layer visibility.
...
![We recommend creating states or component variations as separate components for ease of use.](https://cdn.sanity.io/images/599r6htc/regionalized/91fb60440ac5b5b86332bfa95554ca7eb414970f-2156x1302.png?w=2156&h=1302&q=75&fit=max&auto=format)

We recommend creating states or component variations as separate components for ease of use.
...
![Component descriptions are displayed as tooltips on hover when browsing in the component panel.](https://cdn.sanity.io/images/599r6htc/regionalized/22c2fee9bdd1af6715c0eb530a28abdcda925ce7-2156x582.png?w=2156&h=582&q=75&fit=max&auto=format)
...
![](https://cdn.sanity.io/images/599r6htc/regionalized/99db324ca9d4cfc8a7774d71186e8289c70cb605-2156x628.png?w=2156&h=628&q=75&fit=max&auto=format)
...
![](https://cdn.sanity.io/images/599r6htc/regionalized/02ef3930fc526aa96cd1d9526614e426d19982b4-2156x904.png?w=2156&h=904&q=75&fit=max&auto=format)

Style names and descriptions can be helpful to clarify usage, or create alignment with naming used in your codebase.

_Note: when developers are inspecting your designs, in the code panel, style names will show up as comments in CSS mode and as a line item in table view. The names of color, type, and effect styles will be displayed in addition to their attributes._
...
![](https://cdn.sanity.io/images/599r6htc/regionalized/5416ab93f303dee56daf0dfe2ddb5b89185dc705-2156x708.png?w=2156&h=708&q=75&fit=max&auto=format)
...
![](https://cdn.sanity.io/images/599r6htc/regionalized/3bbdb3f9e708c209a9de8546c3e9ad9f02c28565-2140x922.png?w=2140&h=922&q=75&fit=max&auto=format)
...
A library that exists in a single file.
...
![](https://cdn.sanity.io/images/599r6htc/regionalized/2a7b701d26aea3904cd32e2d55feb76b290e32ff-2156x914.png?w=2156&h=914&q=75&fit=max&auto=format)

Breaking up your components and styles into separated libraries allows users to turn on only the libraries they need.
...
![](https://cdn.sanity.io/images/599r6htc/regionalized/41b7edb4e216e73f3b4525a32de5c2e9f8b91221-2156x1024.png?w=2156&h=1024&q=75&fit=max&auto=format)
...
![](https://cdn.sanity.io/images/599r6htc/regionalized/29a5a0a59740420c3655bfb971919823ec668ac6-2156x774.png?w=2156&h=774&q=75&fit=max&auto=format)

Save time with batch renaming of layers or components.
