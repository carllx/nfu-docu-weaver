参考[clip](https://www.youtube.com/watch?v=SWtS79Jo23U)  
OpenCV => ProxyCubeMotion
动态捕捉 => 曲线 => Force Fields 
粒子 => Malevich 方形 => (浮动 )无重力状态

参考: # [Convert particle system to animated meshes](https://blender.stackexchange.com/a/167633)
```python
import bpy
