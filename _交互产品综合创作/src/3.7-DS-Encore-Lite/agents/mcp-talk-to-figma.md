...
4.  Final Output: Throughout the conversation, I will generate the final, ordered list of precise commands for the MCP Server to execute at each confirmed ste