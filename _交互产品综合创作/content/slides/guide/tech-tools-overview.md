...
**第 1 次接触（Week 3-4）：**
1. 先阅读 `pedagogy-course-integration.md`，了解整体流程
2. 使用【工具 3】创建第一份规范
...
### 教学文档
- [8 周教学计划](pedagogy-course-integration.md) - 完整学习路线
- [Design System 最佳实践](best-practices-designSystem.md) - 深度教程
...
**新手入门：**
1. 从 `pedagogy-course-integration.md` 开始，了解整体流程
...
- 参考 `pedagogy-course-integration.md` 中的故障排查指南
- 联系课程教师获取帮助
